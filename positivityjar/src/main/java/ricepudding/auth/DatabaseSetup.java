...
@DataSourceDefinition(name = "java:global/jdbc/positivity_jar", className = "org.mariadb.jdbc.Driver", url = "jdbc:mariadb://localhost:3306/positivity_jar", user = "root", password = "4nw8Luk1XpKD")
@Singleton
@Startup
